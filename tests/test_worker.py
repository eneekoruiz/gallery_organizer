...
from smart_gallery_v2.core.worker import ProcessingEngine
from smart_gallery_v2.core.models_types import AIResult, DedupeResult, ExifResult, MediaRecord, ThumbnailResult
...
def test_pipeline_step_dispatch(mock_engine, temp_db):
    ...
    fid = temp_db.upsert_file("mock.jpg", "mock.jpg")
    ...
    with patch("smart_gallery_v2.core.worker.Path.exists", return_value=True), \
         patch("smart_gallery_v2.core.worker.Path.stat") as mock_stat, \
...
def test_error_handling_in_pipeline(mock_engine, temp_db):
    ...
    fid = temp_db.upsert_file("fail.jpg", "fail.jpg")
